...
bool going = false;
int max_power = 90, time_step = 100, acceleration_time = 3000;
int power_step = 1; //max_power / (acceleration_time / time_step);
uint32_t power = 0, current_time = 0;

int servo_zero = 90;
int servo_pos = 90; // initial servo position
int servo_dest = servo_zero;
bool turning = false;
